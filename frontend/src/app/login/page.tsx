      ...
      <main className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="w-full">
          ...
          <div className="neo-raised rounded-3xl p-8 md:p-10 space-y-8 bg-[#e8eaf0]">
            ...
            {/* OAuth */}
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center space-x-2 py-3 rounded-xl neo-raised hover:-translate-y-0.5 transition-all">
              ...
              <button className="flex items-center justify-center space-x-2 py-3 rounded-xl neo-raised hover:-translate-y-0.5 transition-all">
                <span className="material-symbols-outlined text-xl text-slate-700 icon-filled">ios</span>
                <span className="text-sm font-semibold text-slate-700">Apple ID</span>
              </button>
            </div>
